...
Adding a Non-Steam "game" to the MicroSD card is as easy as opening the MicroSDeck plugin and clicking on the "..." button for the MicroSD card you want to add the game to, and select the "Edit" option.
